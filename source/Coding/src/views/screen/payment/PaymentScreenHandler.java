...
public class PaymentScreenHandler extends BaseScreenHandler {
    ...
    public PaymentScreenHandler(Stage stage, String screenPath, RentTransaction rentTransaction) throws IOException {
        ...
        btnBackScreen.setOnMouseClicked(e -> {
            try{
    ...
    private void confirmToReturnBike(String method, int total) throws IOException, SQLException {
        ...
        if(response.get("RESULT").equals("PAYMENT SUCCESSFUL!")) {
            ...
            Configs.bike.returnBike(Configs.indexDockReturnBike);
    ...
    private void setUpRent() {
        ...
        btnConfirm.setOnMouseClicked(e -> {
            try{
                confirmToPayOrder();
                LOGGER.info("Rent");
                System.out.println(Configs.bike == null);
