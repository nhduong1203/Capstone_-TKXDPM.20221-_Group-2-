...
//            transaction.setCreatedAt(createdAt);
            ...
            InterbankTransaction transaction =
                    new InterbankTransaction(card.getCardCode(),
                                            card.getOwner(),
                                            Integer.toString(card.getCvvCode()),
                                            card.getDateExpired(),
                                            command,
                                            content,
                                            cost,
            ...
            transToHash.addProperty("secretKey", "BxRAwsTYpcg=");
            ...
            sentJson.addProperty("appCode", "CfO1tA8I8IM=");
            sentJson.addProperty("hashCode", myHash);
            System.out.println("Chuỗi gửi lên: " + sentJson);
